...
for index, row in sample.iterrows():
    ...
    if test1_flag:
        ...
        local_error_result_nonseasonal = local_rmse(df_series["quantity"].iloc[-16:].values,
                                              result_52_nonseasonal["prediction"].iloc[-16:].values)
        local_error_result_seasonal = local_rmse(df_series["quantity"].iloc[-16:].values,
                                                       result_52_seasonal["prediction"].iloc[-16:].values)
        report = report.append([[kunag, matnr, test1_flag, test1_pvalue, test2_flag, test2_value,
                                 error_result_nonseasonal, error_result_seasonal, local_error_result_nonseasonal, local_error_result_seasonal]])
...
report.columns = ["kunag", "matnr", "test1_flag", "test1_pvalue", "test2_flag", "test2_value", "error_result",
                  "error_result_seasonal", "local_error_result_nonseasonal", "local_error_result_seasonal"]
