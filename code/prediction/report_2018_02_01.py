...
for index, row in sample.iterrows():
    ...
    try:
        ...
        if not seas_pres:
            ...
            plt.legend()
            plt.savefig("/home/aman/PycharmProjects/seasonality_hypothesis/report_2018_02_01/"
...
report.to_csv("/home/aman/PycharmProjects/seasonality_hypothesis/report_2018_02_01/report_2018_02_01.csv")
    # except:
    #     pass